...
**_You will now have a PostgreSQL and PGAdmin instance running in the backgorund. We will configure these in a moment_.**
...
- Email: `user@syncra.com` (_this is a dummy email_)
- Password: `password`
